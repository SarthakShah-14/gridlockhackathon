...
def compile_validation_report():
    print("Compiling Model Validation Report...")
    ...
    report_content = f"""# Model Validation & Evaluation Report
...
* The measured **Expected Calibration Error (ECE)** for multi-class severity prediction is **{ece:.4f}**, which represents highly calibrated probability bounds.
* The multi-class Brier score is **{brier:.4f}**, showing strong accuracy and confidence alignment.
...
"""
    ...
    print("Validation report compiled and saved to reports/validation_report.md")
